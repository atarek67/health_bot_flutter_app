    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
              ...
              child: ListTile(
                ...
                builder: (context, state) {
                  if(state is Select_birthDate) {
                    return Text(state.date, style:const TextStyle(fontSize: 20,color:Color.fromARGB(255, 17, 138, 51) ),);
                  }else {
                    return  Text(bloc.birth_date, style:const TextStyle(fontSize: 20,color: Colors.grey),);
                  }
                },
              ),
          ...
          Button('Confirm', const Color.fromARGB(255, 17, 138, 51), Colors.white,
            ...
            Button("Have An Account",const Color.fromARGB(255, 17, 138, 51),Colors.black,signin_function),
